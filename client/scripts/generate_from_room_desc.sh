...
export https_proxy=http://sys-proxy-rd-relay.byted.org:8118 http_proxy=http://sys-proxy-rd-relay.byted.org:8118 no_proxy="*.byted.org,2605:340:cd51:4900:65d4:a9ae:f110:103d,localhost,127.0.0.1,[::1]"
export OPENBLAS_NUM_THREADS=8
export OMP_NUM_THREADS=8

export ISAAC_MCP_PORT=11327
...
python client_generation_room_desc.py \
    --room_desc "A modern office kitchenette with green upper cabinets, white lower cabinets, a water dispenser, a coffee machine, a sink, and a small round wooden table with two gray chairs, set against a yellow accent wall." \
